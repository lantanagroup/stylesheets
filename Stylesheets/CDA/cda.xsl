...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="malicious-content-warning">WARNING: Potentially malicious content found in CDA
      ...
      <body data-spy="scroll" data-target="#navbar-cda">
        ...
        <div class="cda-render toc col-md-3" role="complementary">
          ...
          <xsl:if test="not(//n1:nonXMLBody)">
            <xsl:if
              test="count(/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[n1:section]) > 0">
    ...
    <xsl:if test="n1:author">
      <div class="header container-fluid">
        <xsl:for-each select="n1:author/n1:assignedAuthor">
          <div class="container-fluid">
            <div class="col-md-8">
              <h2 class="section-title col-md-8" id="author-performer">
            ...
            <div class="col-md-4">
              <xsl:if test="n1:addr | n1:telecom">
                <h2 class="section-title col-md-8">Contact</h2>
                <div class="header-group-content col-md-8">
      ...
      <xsl:if test="n1:legalAuthenticator">
        <div class="header container-fluid">
          ...
          <xsl:if
            ...
            <div class="col-md-4">
              <h2 class="col-md-8 section-title">Contact</h2>
              <div class="header-group-content col-md-8">
                <xsl:call-template name="show-contactInfo">
    ...
    <xsl:if test="n1:dataEnterer">
      <div class="container-fluid header">
        <div class="col-md-8">
          ...
          <div class="col-md-8 header-group-content">
            <xsl:call-template name="show-assignedEntity">
        ...
        <xsl:for-each select="n1:documentationOf">
          ...
          <xsl:for-each select="n1:serviceEvent/n1:performer">
            <div class="header-group container-fluid">
              ...
              <div class="container-fluid">
                <h2 class="section-title col-md-8" id="service-event">
          ...
          <div class="container-fluid">
            ...
            <xsl:choose>
              ...
              <xsl:when test="n1:relatedEntity/n1:addr | n1:relatedEntity/n1:telecom">
                <div class="col-md-4">
                  <h2 class="col-md-8 section-title">
                    <xsl:text>Contact</xsl:text>
                  </h2>
                  <div class="col-md-8 header-group-content">
                    <xsl:if test="n1:relatedEntity">
      ...
      <xsl:if test="n1:participant">
        <div class="header container-fluid">
          <xsl:for-each select="n1:participant">
            <xsl:if
              test="not(n1:associatedEntity/@classCode = 'ECON' or n1:associatedEntity/@classCode = 'NOK')">
      ...
      <xsl:for-each select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole">
        <xsl:if test="not(n1:id/@nullFlavor)">
          ...
          <div class="patient-info container-fluid">
            <div class="col-md-8">
              <h2 class="section-title col-md-8">About</h2>
              <div class="header-group-content col-md-8">
                <div class="row">
                  <div class="attribute-title col-md-4">
        ...
        <xsl:for-each select="n1:participant">
          <xsl:if test="n1:associatedEntity/@classCode = 'ECON'">
            <div class="container-fluid" id="emergency-contact">
              <div class="col-md-8">
                <h2 class="section-title col-md-8">Emergency Contact</h2>
                <div class="header-group-content col-md-8">
                  <xsl:call-template name="show-associatedEntity">
                    <xsl:with-param name="assoEntity" select="n1:associatedEntity"/>
                  </xsl:call-template>
      ...
      <xsl:if test="n1:participant">
        <xsl:for-each select="n1:participant">
          <xsl:if test="n1:associatedEntity/@classCode = 'NOK'">
            <div class="container-fluid" id="emergency-contact">
              <div class="col-md-8">
                <h2 class="section-title col-md-8">Next of Kin</h2>
                <div class="header-group-content col-md-8">
                  <xsl:call-template name="show-associatedEntity">
                    <xsl:with-param name="assoEntity" select="n1:associatedEntity"/>
                  </xsl:call-template>
        ...
        <tr>
          ...
          <td class="td_header_role_value">
            <xsl:call-template name="show-time">
              <xsl:with-param name="datetime"
                select="
                  /n1:ClinicalDocument/n1:documentationOf
  ...
  <xsl:template name="formatDateTime">
    ...
    <xsl:if test="string-length($date) > 8">
      ...
      <xsl:if
        test="(string-length($hh) > 1 and not($hh = '00')) or (string-length($mm) > 1 and not($mm = '00'))">
        <xsl:text>, </xsl:text>
  ...
  <xsl:template name="translate-id-type">
  ...
  <xsl:template name="translate-doc-type">
